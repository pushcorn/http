            ...
            Api
                .staticMethod ("import", function (owner, apiClass)
                {
                    owner.apis.push (
                    {
                        ...
                        description: apiClass.getClassChainProperty ("description"),
                        ...
                        responses: apiClass.getPlugins ("responses").map (r => Self.Response.import (owner, r) || r.simpleName)
                    });
                })
            ;
        })
