                ...
                .defineCaster (function (api)
                {
                    if (api instanceof http.Api)
                    {
                        ...
                        api = nit.assign (new Api (
                        {
                            ...
                            method: apiClass.getPlugins.call (api, "conditions").find (c => c instanceof Self.RequestMethod)?.method,
                            path: apiClass.getPlugins.call (api, "conditions").find (c => c instanceof Self.RequestPath)?.path
                        })
                        ,
                        {
                            spec,
