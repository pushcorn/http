    ...
    return (Self = nit.defineClass ("http.Server"))
        ...
        .method ("dispatch", async function (req, res)
        {
            ...
            catch (e)
            {
                if (ctx)
                {
                    ...
                    {
                        self.error ("error.unexpected_error", nit.clone.deep (e));
            ...
            finally
            {
                ...
                if (error)
                {
                    self.error ("error.unexpected_error", nit.clone.deep (error));
        ...
        .method ("start", async function ()
        {
            ...
            self.nodeServer
                ...
                {
                    self.info ("info.server_started", { address: self.address, port });
