module.exports = function (nit, http, Self)
{
    return (Self = http.defineHandler ("http.Api"))
        ...
        .extendStagedMethodQueue ("FinallyQueue", FinallyQueue =>
        {
            FinallyQueue.after ("preFinally", "preFinally.validateResponseType", function (api, ctx)
            {
        ...
        .extendStagedMethodQueue ("CatchQueue", CatchQueue =>
        {
            CatchQueue.after ("preCatch", "preCatch.castSupportedError", function (api, ctx)
            {
                let cls = api.constructor;
