module.exports = function (nit, http, Self)
{
    return (Self = http.defineHandler ("http.Api"))
        ...
        {
            Method
                .afterDispatch ("dispatch.invokeHook", "dispatch.sendHookResult", function (api, ctx)
                {
                ...
                .afterDispatch ("dispatch.sendHookResult", "dispatch.validateResponseType", function (api, ctx)
                {
                    let cls = api.constructor;
                ...
                .beforeFailure ("castSupportedError", function (api, ctx)
                {
                    let cls = api.constructor;
                    let code;
                    let resClass;
