module.exports = function (nit, http, Self)
{
    return (Self = http.defineHandler ("http.Api"))
        ...
        .subclassMethodQueue ("finally", Queue =>
        {
            Queue.after ("preFinally", "preFinally.validateResponseType", function (api, ctx)
            {
        ...
        .subclassMethodQueue ("catch", Queue =>
        {
            Queue.after ("preCatch", "preCatch.castSupportedError", function (api, ctx)
            {
                let cls = api.constructor;
