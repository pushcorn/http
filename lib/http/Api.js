module.exports = function (nit, http, Self)
{
    return (Self = http.defineConditional ("http.Api"))
            ...
            Context
                ...
                .method ("send", function (resp)
                {
                    if (!(resp instanceof Self.Response))
                    {
                        ...
                        let resCls = apiCls.getClassChainProperty ("responses");
        ...
        {
            this.responses.push (...nit.array (arguments).map (r => nit.lookupComponent (r, "responses", "http.Response")));
