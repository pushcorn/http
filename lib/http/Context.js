module.exports = function (nit, http, Self)
{
    ...
    return (Self = nit.defineClass ("http.Context", "nit.Context"))
        ...
        .method ("resolveAsset", async function (path)
        {
            ...
            return await nit.find (self.assetResolvers, async (resolver, f) => (f = await resolver.resolve (path)) && nit.find.Result (f))
        ...
        .method ("loadTemplate", async function (path)
        {
            ...
            return await nit.find (self.templateLoaders, async (loader, t) => (t = await loader.load (path, self)) && nit.find.Result (t))
