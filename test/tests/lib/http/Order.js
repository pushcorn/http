...
test.method ("http.Order", "onRegisterPlugin", true)
    .should ("add the static methods orderBefore and orderAfter to the host class")
        ...
        .expectingMethodToReturnValueOfType ("args.0.orderBefore", "function", "B")
        .expectingMethodToReturnValueOfType ("args.0.orderAfter", "function", "C")
        .expectingMethodToReturnValue ("args.0.orders.0.toPojo", { before: "A", after: "B" })
        .expectingMethodToReturnValue ("args.0.orders.1.toPojo", { before: "C", after: "A" })
        .commit ()
;
