test.method ("http.serviceplugins.PathPrefixer", "preInit")
...
test.method ("http.serviceplugins.PathPrefixer", "preDispatch")
...
test.method ("http.serviceplugins.PathPrefixer", "postDispatch")
